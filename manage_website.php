                                        ...
                                        <textarea class="textarea_editor form-control" name="footer" rows="5" placeholder="Enter text ..." style="height:300px;"><?php echo $footer;?></textarea>
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                  <image class="profile-img" src="./assets/uploadImage/Logo/<?=$website_logo?>" style="max-width:150px;height:auto;display:block;margin-bottom:10px;">
                          ...
                          <input type="file" class="form-control" name="website_image">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                  <image class="profile-img" src="./assets/uploadImage/Logo/<?=$invoice_logo?>" style="max-width:150px;height:auto;display:block;margin-bottom:10px;">
                          ...
                          <input type="file" class="form-control" name="invoice_image">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                  <image class="profile-img" src="./assets/uploadImage/Logo/<?=$login_logo?>" style="max-width:150px;height:auto;display:block;margin-bottom:10px;">
                          ...
                          <input type="file" class="form-control" name="login_image">
                                          ...
                                          <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                  <image class="profile-img" src="./assets/uploadImage/Logo/<?=$background_login_image?>" style="max-width:150px;height:auto;display:block;margin-bottom:10px;">
